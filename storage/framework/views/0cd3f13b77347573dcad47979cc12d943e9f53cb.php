                ...
                <div class="well py-4">
                    <div class="row" id="keyContainer" align="center">
                        ...
                        <div class="col-md-2 answerKey">
                            <img src="<?php echo e(asset("images/answerKeys/hiddenA.png")); ?>" alt="Key A" />
                        </div>
                        <div class="col-md-2 answerKey">
                            <img src="<?php echo e(asset("images/answerKeys/hiddenB.png")); ?>" alt="Key B" />
                        </div>
                        <div class="col-md-2 answerKey">
                            <img src="<?php echo e(asset("images/answerKeys/hiddenC.png")); ?>" alt="Key C" />
                            </div>
                        <div class="col-md-2 answerKey">
                            <img src="<?php echo e(asset("images/answerKeys/hiddenD.png")); ?>" alt="Key D" />
                        </div>
                    -->
                    </div>
                    <input type="hidden" value="<?php echo e($quiz_id); ?>" id="quiz_id" />
                    <input type="hidden" value="<?php echo e($keys); ?>" id="numQuestions" />
                    <input type="hidden" value="<?php echo e(asset("images/answerKeys/hiddenA.png")); ?>"  id="key_A_path" />
